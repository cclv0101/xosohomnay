    ...
    <table class="table table-hover mb-0">
        ...
        <tbody>
            <?php foreach ($services as $service) : ?>
                ...
                <tr>
                    <td><span class="text-truncate-3" id="service_title_<?=$service['service_id']?>"><?= $service['service_title'] ?></span></td>
                    ...
                    <td>
                        <a class="pointer badge green" data-toggle="modal" data-target="#confirmRestore" onclick="restoreService(<?= $service['service_id'] ?>)">
                            <i class="sort fa fa-undo"></i> Khôi phục</a>
                        <a class="pointer badge red" data-toggle="modal" data-target="#confirmDelete" onclick="deleteService(<?= $service['service_id'] ?>)">

    ...
    <table class="table table-hover mb-0">
        <thead>
            <tr>
                ...
                <th class="th-lg" style="width: 15%"><a>Hành động</a></th>
            </tr>
        </thead>
        <tbody>
            <?php foreach ($articles as $article) : ?>
                ...
                <tr>
                    <td><span class="text-truncate-3" id="article_title_<?=$article['article_id']?>"><?= $article['article_title'] ?></span></td>
                    ...
                    <td>
                        <a class="pointer badge green" data-toggle="modal" data-target="#confirmRestore" onclick="restoreArticle(<?= $article['article_id'] ?>)">
                            <i class="fa fa-undo"></i> Khôi phục</a>
                        <a class="pointer badge red" data-toggle="modal" data-target="#confirmDelete" onclick="deleteArticle(<?= $article['article_id'] ?>)">

<main>
    <div class="box row flex-center-center m-2">
        ...
        <div class="col-md-3 col-4 px-1">
            <a href="<?= URL_DOMAIN.'/admin/article/list'.URL_FOOT ?>" class="btn btn-primary m-0"><i class="fas fa-newspaper"></i> <span class="clearfix d-none d-sm-inline-block"> Bài viết</span></a>
            <a href="<?= URL_DOMAIN.'/admin/article/trashlist'.URL_FOOT ?>" class="btn btn-danger m-0"><i class="fas fa-trash"></i> <span class="clearfix d-none d-sm-inline-block"> Dọn rác</span></a>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-notify modal-success" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="heading">
                    <b>Xác nhận khôi phục bài viết?</b>
                </div>
            </div>
            <div class="scroll-y">
            ...
            <div class="modal-footer justify-content-center">
                <a type="button" class="btn btn-success" onclick="restoreArticleOk(this)"><b>Đồng ý</b></a>
...
<div class="modal fade" id="confirmDelete" tabindex="-1" role="dialog" aria-labelledby="myConfirmTrash" aria-hidden="true">
    <div class="modal-dialog modal-notify modal-danger" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <a type="button" class="btn btn-danger" onclick="deleteArticleOk(this)"><b>Đồng ý</b></a>
                <a type="button" class="btn btn-secondary" data-dismiss="modal">Hủy bỏ</a>
            </div>
        </div>
    </div>
...
<script>
    ...
    function restoreArticle(id) {
        ...
        $("#restore_review_title").text($("#article_title_"+id).text());
        $("#restore_review_description").text($("#article_desc_"+id).text());
        $("#restore_review_image").attr("src", $("#article_image_"+id).attr("src"));
    }

    function restoreArticleOk(t) {
